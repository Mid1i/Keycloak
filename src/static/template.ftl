...
<head>
    ...
    <style>
      @font-face {
        font-family: "Inter";
        font-weight: 400;
        src: url("${url.resourcesPath}/fonts/Inter-Regular.woff2");
      }

      @font-face {
        font-family: "Inter";
        font-weight: 600;
        src: url("${url.resourcesPath}/fonts/Inter-Semibold.woff2");
      }

      @font-face {
        font-family: "Inter";
        font-weight: 700;
        src: url("${url.resourcesPath}/fonts/Inter-Bold.woff2");
      }
    </style>
